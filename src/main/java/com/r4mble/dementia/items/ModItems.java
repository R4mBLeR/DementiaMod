    ...
    public static final RegistryObject<Item> BLUE_ANTI_DEMENTIA_PILL = ITEMS.register("blue_anti_dementia_pill",
            () -> new Item(new Item.Properties().component(
                    ...
                    Consumable.builder()
                            ...
                            .build()
            ).setId(ResourceKey.create(Registries.ITEM, ResourceLocation.parse( DementiaMod.MOD_ID+":blue_anti_dementia_pill")))));
    ...
    public static final RegistryObject<Item> RED_ANTI_DEMENTIA_PILL = ITEMS.register("red_anti_dementia_pill",
            () -> new Item(new Item.Properties().component(
                    ...
                    Consumable.builder()
                            .hasConsumeParticles(false)
                            .onConsume(
                                    new ApplyStatusEffectsConsumeEffect(new MobEffectInstance(ModEffects.ANTI_DEMENTIA.getHolder().get(), 12000, 0), 1F)
                            )
                            .build()
            ).setId(ResourceKey.create(Registries.ITEM, ResourceLocation.parse( DementiaMod.MOD_ID+":red_anti_dementia_pill")))));
}